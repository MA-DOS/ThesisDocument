...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{
            ...
            \midrule
            \texttt{atacseq}      & 268                      & 32                   & 437                   & Analysis pipeline used for ATAC-seq data                                                       \\
            \texttt{chipseq}      & 506                      & 34                   & 777                   & analysis pipeline used for Chromatin ImmunoPrecipitation sequencing                            \\
            \texttt{rnaseq}       & 295                      & 30                   & 631                   & Analysis of RNA sequencing data                                                                \\
            \texttt{scnanoseq}    & 210                      & 6                    & 470                   & Analysis pipeline for 10X Genomics single-cell/nuclei RNA-seq data                             \\
            \texttt{smrnaseq}     & 908                      & 65                   & 1524                  & Small RNA sequencing                                                                           \\
            \texttt{pixelator}    & 55                       & 12                   & 172                   & Analysis of Molecular Pixelation                                                               \\
...
\begin{table}[H]
    ...
    \small\caption{Monitoring Configuration Overview}
...
\myparagraph{Results of Makespan and Energy Consumption}
...
\myparagraph{Distribution of Makespan and Energy Consumption for all Workflows}
...
A similar pattern appears in the makespan distribution. The relative performance of the algorithms with respect to runtime mirrors their energy distribution behavior. This consistency supports the intuition that faster algorithms also tend to consume less energy overall.
...
\myparagraph{Summary Statistics of Energy Efficiency, Makespan, and Energy Consumption}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{
            ...
            \toprule
            \textbf{Workflow}     & \textbf{Best Approach} & \textbf{Avg. Baseline Efficiency} & \textbf{Best Efficiency} & \textbf{Improvement} \\
            \midrule
            \texttt{atacseq}      & ShaRiff-3              & 0.023304                          & 0.022627                 & 2.906                \\
            \texttt{chipseq}      & ShaRiff-3              & 0.024819                          & 0.024764                 & 0.225                \\
            \texttt{methylseq}    & ShaRiff-1              & 0.022601                          & 0.022726                 & -0.556               \\
            \texttt{oncoanalyser} & ShaRiff-3              & 0.022109                          & 0.021989                 & 0.540                \\
            \texttt{pixelator}    & ShaRiff-1              & 0.024160                          & 0.024735                 & -2.379               \\
            \texttt{rnaseq}       & ShaRiff-2              & 0.024388                          & 0.024759                 & -1.521               \\
            \texttt{scnanoseq}    & ShaRiff-3              & 0.022203                          & 0.022186                 & 0.076                \\
            \texttt{smrnaseq}     & ShaRiff-1              & 0.025061                          & 0.022142                 & 11.649               \\
            \texttt{viralrecon}   & ShaRiff-2              & 0.023236                          & 0.022030                 & 5.191                \\
            \bottomrule
        \end{tabular}
    }
    \small
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{
            ...
            \toprule
            \textbf{Workflow}     & \textbf{Best ShaRiff Approach} & \textbf{Avg. Energy Consumption MJ} & \textbf{Best ShaRiff Energy Consumption} & \textbf{Improvement} \\
            \midrule
    ...
    \small
    \caption{Energy Consumption improvement of the best \textit{ShaRiff} approach compared to the average baseline efficiency per workflow.}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{
            ...
            \toprule
            \textbf{Workflow}     & \textbf{Best ShaRiff Approach} & \textbf{Avg. Baseline Makespan} & \textbf{Best ShaRiff Makespan} & \textbf{Improvement} \\
            \midrule
