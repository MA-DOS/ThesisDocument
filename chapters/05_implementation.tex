...
Each implemented component in \ref{fig:05-system-overview} is denoted with a number. These numbers correspond with the following table \ref{tab:technology} and mention the technology and design choices.
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{
            ...
            \multicolumn{3}{l}{\textbf{ (1) Workflow Execution}}                                                                                                     \\[3pt]
            ...
            \midrule
            \multicolumn{3}{l}{\textbf{ (1) Monitoring System}}                                                                                                      \\[3pt]
