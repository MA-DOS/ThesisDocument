{\sffamily\color{black}\raggedright\setlength{\parindent}{0cm}\large\onehalfspacing
\AddToShipoutPicture*{
    \put(-4,0){
...
\vfill
\begin{center} % Hier beginnt die Zentrierung für den gesamten Text
\vspace*{5cm}
...
\small{\facultyName \\
    \departmentName}
\vspace{1cm}
\end{center} % Hier endet die Zentrierung für den gesamten Text
}
